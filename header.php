...
?> 
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html"><?php echo get_bloginfo('name'); ?><span>.</span></a>
        ...
        <form class="form-inline" action="<?php echo get_site_url(); ?>" method="get">
                    <!--le name de cette input est "s" pour string afin de rechercher un mot donc pour une recherche, doit toujours être s-->
                    <input class="form-control" type="text" name="s" id="">
                    <button class="btn bg-white ml-3" type="submit"><i class="fa fa-search">rechercher</i></button>
                </form>
			<?php
        wp_nav_menu([
            // 'menu' => 'main-menu',
