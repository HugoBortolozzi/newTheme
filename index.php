...
//Ajout de la section top-carousel
get_template_part('templates/top-carousel');

//Ajout de la section recent-stories
get_template_part('templates/recent-stories');

//Ajout de la section featured-posts
get_template_part('templates/featured-posts');

//Ajout de la section roger-bosch
get_template_part('templates/roger-bosch');

//Ajout de la section holidays-recipes
get_template_part('templates/holidays-recipes');
