      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate pb-5 text-center">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="http://localhost:8080">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Lifestyle <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
        			...
        			<div class="col-md-6 col-lg-12 ftco-animate">
    						<div class="blog-entry d-lg-flex">
			    				...
			    				<div class="text px-md-4 px-lg-5 half pt-3">
	    							...
	    							<p class="mb-0"><a href="http://localhost:8080/?page_id=37" class="btn btn-primary">Read More <span class="icon-arrow_forward ml-4"></span></a></p>
	    						</div>
		    				</div>
    					</div>
    					<div class="col-md-6 col-lg-12 ftco-animate">
    						<div class="blog-entry d-lg-flex">
    							<div class="half">
			    					<a href="http://localhost:8080/?page_id=37" class="img d-flex align-items-end" style="background-image: url(<?php echo get_template_directory_uri(); ?>/images/image_2.jpg);">
			    						<div class="overlay"></div>
				    				</a>
			    				</div>
			    				<div class="text px-md-4 px-lg-5 half pt-3">
    					...
    					<div class="col-md-6 col-lg-12 ftco-animate">
    						<div class="blog-entry d-lg-flex">
    							<div class="half">
			    					<a href="http://localhost:8080/?page_id=37" class="img d-flex align-items-end" style="background-image: url(<?php echo get_template_directory_uri(); ?>/images/image_6.jpg);">
			    						<div class="overlay"></div>
				    				</a>
			    				</div>
			    				<div class="text px-md-4 px-lg-5 half pt-3">
