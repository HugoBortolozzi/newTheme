      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate pb-5 text-center">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="http://localhost:8080">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Article Single<i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 order-lg-last ftco-animate">
            ...
            <p>
              <img src="<?php echo get_template_directory_uri(); ?>/images/image_6.jpg" alt="" class="img-fluid">
            </p>
            ...
            <p>
              <img src="<?php echo get_template_directory_uri(); ?>/images/image_4.jpg" alt="" class="img-fluid">
            </p>
